...
class ReportTopAppsVisualTest {
    ...
    @Test
    fun reportTopAppsRenderProportionalUsageBars() {
        ...
        Thread {
            database.focusSessionDao().insert(
                reportSession(
                    clientSessionId = "report-bars-chrome",
            ...
            database.focusSessionDao().insert(
                reportSession(
                    clientSessionId = "report-bars-youtube",
        ...
        val recyclerView = activity.findViewById<RecyclerView>(R.id.reportTopAppsRecyclerView)
